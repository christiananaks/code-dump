...
const MONGODB_URI = `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0.ytr0dpc.mongodb.net/${process.env.MONGO_DEFAULT_DATABASE}`;
...
app.use((error, req, res, next) => {
  console.log("APP level error handler", error);
